    ...
    use App\Http\Controllers\DeleteCompiledViewsController;
    use App\Http\Controllers\Front\FrontController;
    use App\Http\Controllers\CacheController;
    use App\Http\Controllers\ConfigCacheController;
    use App\Http\Controllers\RoutingCacheController;
    ...
    */
    ...
    // compiled views clear routes

    Route::get('delete-compiled-views', [DeleteCompiledViewsController::class, 'index'])->name('delete.compiled.views');
    Route::post('delete-compiled-views', [DeleteCompiledViewsController::class, 'deleteCompiledViews']);

    // compiled views clear routes end

    //Cache Clear Routes

    Route::match(['get', 'post'], '/clear-cache', [CacheController::class, 'clearCache'])->name('clear.cache');

    //Cache Clear Routes ends


    //Config Cache Clear Routes

    Route::post('/clear-config-cache', [ConfigCacheController::class, 'clearConfigCache'])->name('clear.config.cache');

    //Config Cache Clear Routes ends

    //Routing Cache Clear Routes

    Route::post('/clear-routing-cache', [RoutingCacheController::class, 'clearRoutingCache'])->name('clear.routing.cache');

    //Routing Cache Clear Routes ends

    //Clear the system log routes

    Route::post('/clear-log-files', [LogController::class, 'clearLog'])->name('clear.log');
    //Clear the system log routes ends
